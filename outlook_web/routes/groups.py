...
def create_blueprint() -> Blueprint:
    ...
    bp.add_url_rule("/api/groups/<int:group_id>", view_func=groups_controller.api_get_group, methods=["GET"])
    ...
    bp.add_url_rule("/api/groups/<int:group_id>/export", view_func=groups_controller.api_export_group, methods=["GET"])
    return bp
